public class Product {
    ...
    private Date manafacturingDate;  // composition
    ...
    public Product(String name, String brand, String category, double price, int quantity, int warrantyMonths) {
        this(name, brand, category, price, quantity, warrantyMonths, new Date(1,1,1));

    }

    public Product(Product other) {
        this(other.name, other.brand, other.category, other.price, other.quantity, other.warrantyMonths, other.manafacturingDate);
    }

    public Product(String name, String brand, String category, double price, int quantity, int warrantyMonths, Date manafacturingDate) {
        this.id = generateId();
        setName(name);
        setBrand(brand);
        ...
        this.manafacturingDate=new Date(manafacturingDate);  // deep copy
    }
    ...
    public String toString() {
        return String.format(
                "%-9s | %-12s | %-28s | %-10s | Rs%8.2f | Qty:%3d | Warranty:%2d mo | Value:Rs%9.2f",
                id, brand, name, category, price, quantity, warrantyMonths, inventoryValue()
        );
    }
}